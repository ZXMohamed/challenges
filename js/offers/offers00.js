    ...
    docsnap.docs.map((post) => {
        ...
        <section class="offerrightside" >
            ...
            <div class="offerspecial">
                ...
                <div class="container text-center">
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4">
                        <div class="col">${post.data().freetime&&post.data().freetime.saturday!="NULL"&&post.data().freetime.saturday?"Saturday | "+post.data().freetime.saturday:""}</div>
                        <div class="col">${post.data().freetime&&post.data().freetime.sunday!="NULL"&&post.data().freetime.sunday?"Sunday | "+post.data().freetime.sunday:""}</div>
                        <div class="col">${post.data().freetime&&post.data().freetime.monday!="NULL"&&post.data().freetime.monday?"Monday | "+post.data().freetime.monday:""}</div>
                        <div class="col">${post.data().freetime&&post.data().freetime.tuesday!="NULL"&&post.data().freetime.tuesday?"Tuesday | "+post.data().freetime.tuesday:""}</div>
                        <div class="col">${post.data().freetime&&post.data().freetime.wednesday!="NULL"&&post.data().freetime.wednesday?"Wednesday | "+post.data().freetime.wednesday:""}</div>
                        <div class="col">${post.data().freetime&&post.data().freetime.thursday!="NULL"&&post.data().freetime.thursday?"Thursday | "+post.data().freetime.thursday:""}</div>
                        <div class="col">${post.data().freetime&&post.data().freetime.friday!="NULL"&&post.data().freetime.friday?"Friday | "+post.data().freetime.friday:""}</div>
                    </div>
                </div>
            </div>
            <br>
            ...
            <div class="offerfooter">
                ...
                <div class="offerprice" data-bs-toggle="offcanvas" data-bs-backdrop="static" data-bs-target="#offcanvasBottom">
                   <!-- price:200$ --><br>
                    <button id="${post.id}chat" class="offersubscribe" style="font-family: icons;" data-bs-toggle="collapse" data-bs-target="#collapseWidthExample">&#xf075;&nbsp;&nbsp;chat</button>
                </div>
            </div>
