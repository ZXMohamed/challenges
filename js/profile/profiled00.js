...
const profileFridaytime = document.getElementById("profileFridaytime");
const profileThursdaytime = document.getElementById("profileThursdaytime");
const profileWednesdaytime = document.getElementById("profileWednesdaytime");
const profileTuesdaytime = document.getElementById("profileTuesdaytime");
const profileMondaytime = document.getElementById("profileMondaytime");
const profileSundaytime = document.getElementById("profileSundaytime");
const profileSaturdaytime = document.getElementById("profileSaturdaytime");
...
onAuthStateChanged(auth, async (user) => { console.log(user);
    if (user) {
        ...
        if (docsnap.exists()) {
            ...
            if(u_data.time){
                profileFridaytime.value = u_data.freetime.friday;
                profileThursdaytime.value = u_data.freetime.thursday;
                profileWednesdaytime.value = u_data.freetime.wednesday;
                profileTuesdaytime.value = u_data.freetime.tuesday;
                profileMondaytime.value = u_data.freetime.monday;
                profileSundaytime.value = u_data.freetime.sunday;
                profileSaturdaytime.value = u_data.freetime.saturday;
            }
        }
        else {
...
var dtime={}
 profileFridaytime.value.trim() !=""?dtime.friday=profileFridaytime.value:dtime.friday="NULL" 
 profileThursdaytime.value.trim() !=""?dtime.thursday=profileThursdaytime.value:dtime.thursday="NULL" 
 profileWednesdaytime.value.trim() !=""?dtime.wednesday=profileWednesdaytime.value:dtime.wednesday="NULL" 
 profileTuesdaytime.value.trim() !=""?dtime.tuesday=profileTuesdaytime.value:dtime.tuesday="NULL" 
 profileMondaytime.value.trim() !=""?dtime.monday=profileMondaytime.value:dtime.monday="NULL" 
 profileSundaytime.value.trim() !=""?dtime.sunday=profileSundaytime.value:dtime.sunday="NULL" 
 profileSaturdaytime.value.trim() !=""?dtime.saturday=profileSaturdaytime.value:dtime.saturday="NULL" 
