...
onAuthStateChanged(auth, async (user) => { console.log(user);
    if (user) {
        ...
        if (docsnap.exists()) {
            ...
            if(u_data.time){
                profileFridaytime.value = u_data.time.friday;
                profileThursdaytime.value = u_data.time.thursday;
                profileWednesdaytime.value = u_data.time.wednesday;
                profileTuesdaytime.value = u_data.time.tuesday;
                profileMondaytime.value = u_data.time.monday;
                profileSundaytime.value = u_data.time.sunday;
                profileSaturdaytime.value = u_data.time.saturday;
            }
        }
        else {
...
var dtime={}
 profileFridaytime.value.trim() !=""?dtime.friday=profileFridaytime.value:false 
 profileThursdaytime.value.trim() !=""?dtime.thursday=profileThursdaytime.value:false 
 profileWednesdaytime.value.trim() !=""?dtime.wednesday=profileWednesdaytime.value:false 
 profileTuesdaytime.value.trim() !=""?dtime.tuesday=profileTuesdaytime.value:false 
 profileMondaytime.value.trim() !=""?dtime.monday=profileMondaytime.value:false 
 profileSundaytime.value.trim() !=""?dtime.sunday=profileSundaytime.value:false 
 profileSaturdaytime.value.trim() !=""?dtime.saturday=profileSaturdaytime.value:false 
